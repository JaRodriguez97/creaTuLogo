...
export class AppComponent implements OnInit {
  ...
  constructor(
    ...
    public spinner: NgxSpinnerService // public productsServices: ProductsService
  ) {}
  ...
  //     return Swal.fire({
  //       icon: 'warning',
  //       html: '<span>Por favor inicia sesión primero para enlistar los productos favoritos</span>',
  //     });

  //   if (this.user.favoritos && this.user.favoritos.length)
  //     return this.ngOnInit().then(() =>
  //       this.renderer.addClass(this.favorites.nativeElement, 'active')
  //     );

  //   return Swal.fire({
  //     icon: 'warning',
  //     html: '<span>No has marcado ningun producto como favorito</span>',
  //   })
  //     .then(() => this.ngOnInit())
  //     .finally(() => this.spinner.hide());
  // }
